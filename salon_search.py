...
#フィルタ設定
price_limit=st.slider("最低カツト価格の上限",min_value=2000,max_value=8500,value=6000)
score_limit=st.slider("人気スコアの下限",min_value=0.0,max_value=35.0,value=5.0)
...
#詳細リンクの表示
seletcted_salon = st.selectbox('気になるサロンを選んで詳細を確認',filtered_df['name_salon'])
